    ...
    <section class="py-10 bg-black sm:pt-16 lg:pt-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <ul class="flex items-center space-x-3 mt-9">
              <li>
                <button class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                  <svg
                    class="w-4 h-4"
          ...
          <div>
            ...
            <ul class="mt-6 space-y-4">
              <li>
                <button class="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
                  {" "}
                  About{" "}
                </button>
              </li>
        ...
        <p class="text-sm text-center text-white">
          © Copyright 2021, All Rights Reserved by InnoVantage Tech
        </p>
      </div>
    </section>
  );
